...
- **Select Menus**: Drop-down menus used to select a few options from a list.
- **Modals**: Form-like modals that can be used to ask for input from a user.

**Application Commands**

- **Slash Commands**: Commands that can be used with a `/` prefix.
