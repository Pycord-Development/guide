...
Drop-down menus used to select a few options from a list.
- [**Modals**](https://discord.com/developers/docs/interactions/message-components#text-inputs):
Form-like modals that can be used to ask for input from a user.
...
![Select Menu Example Image](../assets/select-menus-example.png)
...
![Text Modal Example Image](../assets/modal-example.png)
...
<DiscordMessages>
  ...
  >
    ...
    Message 930650407917748286 sent by Guide Man reversed is "sus m'I"
  </DiscordMessage>
</DiscordMessages>
...
<DiscordMessages>
  <DiscordMessage
    ...
    avatar="green"
  >
    Other Guide Man has been on Discord for so long
  </DiscordMessage>
  <DiscordMessage
    author="Guide Bot"
    avatar="red"
...
by now, right? The links people send in DMs and servers telling you it's Nitro or a game them and
...
aren't under control. Discord is doing everything in their power to stop it, and this includes using
