...
approve bots that simply *prefer* prefix commands. So, if your bot doesn't have an automoderator,
...
*hated* it. There were complaints everywhere. At the time, slash commands were thought to be clunky,
