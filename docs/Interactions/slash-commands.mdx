...
![Picture of the subcommands in the Slash Command Menu](../assets/groups-and-subcommands.png)

You'll notice that there's the name of the Slash Command Group and then the name of the subcommand seperated by a space.
