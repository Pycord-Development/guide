...
Shortly after buttons, Discord added their second message component: Select Menus. Select Menus allow users
...
[Text Modals](text-modals). Select Menus make it easy for users to pick one or multiple options from
