...
Now that you have an account for your bot, you need to login. In order to login, we need the bot's
...
Now you have finished creating your first Pycord bot! What we have showed you is just the basic structure
...
Prefixed commands are an older method of creating bot commands that listens for messages and replies
