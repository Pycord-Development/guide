...
it can often go offline or stop its own process. For this, make sure you have proper error handling.
Also be sure to pay attention to your hosting provider's updates or news, as they usually notify
users of when they plan on doing maintanence to their servers, making their services unavailable for
a short time.
