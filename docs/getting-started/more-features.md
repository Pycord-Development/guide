...
First, you need to ask Discord to send you events. This is done via "Intents". Read up the [Intents](../popular-topics/intents.md) page for more information.
...
```
# link with more-features-pycord-guide-embed.json
```
...
```
# link with more-features-embed.json
```

<br />

This simple command sends replies to a [slash command](../interactions/application-commands/slash-commands.md) with an embed.
Let's break it down:
