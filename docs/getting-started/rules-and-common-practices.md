...
[this page](../popular-topics/sharding.md). Sharding is the process of taking your bot
...
bots [here](../popular-topics/subclassing-bots.md)

### Your Bot's Token

Your bot is only able to be run for one reason: its token. If you followed the
[guide for creating your first bot](creating-your-first-bot.md), you should already know a bit about
...
to keep your token safe. To learn how to do so, read [this part](creating-your-first-bot.md#tokens) of
