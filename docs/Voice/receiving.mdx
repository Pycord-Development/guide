...
For users that want extra examples, you can find some in Pycord's [GitHub repository](https://github.com/Pycord-Development/pycord/blob/master/examples/audio_recording.py).
...
<DiscordMessages>
  <DiscordMessage author="Guide Bot" avatar="red" bot>
    ...
    <DiscordMention highlight={true}>GuideMan</DiscordMention>
  </DiscordMessage>
</DiscordMessages>
...
Congratulations! You have now implemented voice recording into your bot! Most bots and Discord API wrappers don't have this as a feature, so this is quite a feat. Thankfully, Pycord makes it easy to make complex bots.
