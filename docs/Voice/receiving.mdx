...
The first thing you want to do is make a cache of your voice connections. This isn't difficult, as
...
To make a callback, you will want to define the currently undefined `once_done` function inside of
our command, like so:
