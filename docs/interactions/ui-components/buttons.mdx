...
Buttons weren't the only update to the interactions system in Discord. Discord also added [drop-down menus](./dropdowns)
called Select Menus. Discord is also still working on more interaction elements!
