...
[`discord.ui.select`](https://docs.pycord.dev/en/master/api.html#discord.ui.select).
...
- `options`*: A list of [`discord.SelectOption`](https://docs.pycord.dev/en/master/api.html#discord.SelectOption) values. These are the options that can be selected in this menu.
...
In the `options` parameter, you pass a list of [`discord.SelectOption`](https://docs.pycord.dev/en/master/api.html#discord.SelectOption) values. This class also has a few parameters:
...
<Tabs>
<TabItem value="0" label="Specifing time when creating a view object">
...
<TabItem value="1" label="Specifing the time when subclassing">
