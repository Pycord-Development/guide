...
allow for an alternative to prefix commands without needing the Message Content intent.
...
This is what a Slash Command looks like. Not very different from a prefix command,
