...
Pycord is a modern, easy to use, feature-rich, and async ready API wrapper for Discord, written in Python. Pycord is a maintained fork of [discord.py](https://github.com/Rapptz/discord.py) that aids you in creating Discord bots with Python.
...
Here are some resources that we personally recommend:
