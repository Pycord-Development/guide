...
When you see ellipsis(That's the three dots!) in this guide, it is a placeholder for code that you need to fill in. Sometimes, it may be an entire command's code, while other times it could be something simple like a Guild ID. Make sure to replace them before running your bot!
