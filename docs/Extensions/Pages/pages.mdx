...
### PaginatorMenu
This class represents the `discord.Select` menu used to navigate between `PageGroup` instances. If subclassed, you'll most likely want to call `super()` in your `__init__` method.
