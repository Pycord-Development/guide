...
Pycord's `commands` extension comes with it's own build-in help commands. In this guide, we will take a look at them as well as learn how to create your own. Let's dive in!
...
We override this method because we don't want to change the content of the pages, just how they send.
