...
not work on it's own. In your main bot file, you must add the following code:
...
When using a cog instead of a main file, there are some changes you have to make to your code. This
