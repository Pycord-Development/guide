...
=== "Default Help Command"
    ...
    )  # help_command is DefaultHelpCommand by default so it isn't necessary to enable it like this
    ...
    ```
    # link with help-default-response.json
    ```
...
=== "Minimal Help Command"
    ...
    ```
    # link with help-minimal-response.json
    ```
...
```
# link with help-minimal-embed.json
```
...
```
# link with help-error-user-msg.json
# link with help-error-embed.json
```
...
!!! info "Related Topics"
    ...
    - [Subclassing Bots](../../popular-topics/subclassing-bots.md)
    - [Prefixed Commands](prefixed-commands.md)
    - [Cogs](../../popular-topics/cogs.md)
