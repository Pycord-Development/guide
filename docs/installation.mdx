...
If you want to voice your opinion you can do it [here](https://github.com/pypa/pypi-support/issues/1438) or [here](https://github.com/alesanfra/pycord/issues/2)
