...
:::caution
Uninstalling `discord.py` *after* installing `py-cord` can cause issues. You have been warned.
:::
...
:::caution
The development build may not be stable and cause bugs, however, you will be on cutting edge features.
:::
...
:::important
Git is required to install this build. [Learn how you can install Git](/guide/More/git).
:::
