...
Not all the methods and attributes will be covered in this guide, but you can find them in the documentation!
[Check it out!](https://docs.pycord.dev/en/master/api.html#discord.Thread)
...
(which can be unlocked with server boosting level 2) do not require a starting message.
