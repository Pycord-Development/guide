...
You can install Git for your MacOS computer via [Git for Mac](https://git-scm.com/download/mac). Alternatively, it can be installed from the Xcode Command Line Tools by installing Xcode from the App Store, or by running this:
