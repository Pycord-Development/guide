...
a number of gateway connections."
...
Sharding in Pycord is straight-forward.
...
These new objects have inherit from the original objects, so all of the functions from those other types should be present. 
