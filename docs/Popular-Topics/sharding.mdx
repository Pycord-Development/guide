...
Sharding in Pycord is straightforward and extremely easy.
...
These new objects have been inherited from the original objects, so all of the functions from those other types should be present. 
