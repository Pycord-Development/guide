...
## Credits
This guide has taken inspiration from some places, which will be credited here.

the [original pycord guide](https://namantech.me/pycord), of which most of you know of is the center of design for everything here.

the [discord.js](discordjs.guide) guide is the project which this guide is mostly based off of style wise.
