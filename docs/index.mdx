...
We would like to thank the [discord.js guide](https://discordjs.guide), which inspired this guide style wise, and the [original Pycord Guide](https://namantech.me/pycord), which inspired some of the content in this guide.

This guide was created using [Docusaurus v2](https://docusaurus.io), a modern static site generator for React. We would also like to thank Danktuary for his [`@discord-message-components/react`](https://www.npmjs.com/package/@discord-message-components/react) package, from which we took the Discord message components.

And finally, we would like to thank the amazing community of Pycord users, contributers and developers.
